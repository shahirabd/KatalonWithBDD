...
class LoginSteps {
	...
	def verifyHomePage() {
		CustomKeywords.'commonSteps.Common.VerifyAppointmentPage'(true)
	}

	@Then("Warning message is displayed")
	def verifyWarningMsg() {
		WebUI.verifyElementPresent(findTestObject('Object Repository/Login_Page_CURA/Login_message'), 5)
		WebUI.closeBrowser()
	}
}